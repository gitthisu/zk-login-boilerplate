...
export class AuthService {
    // gets the address seed
    // the address seed is used to generate a keypair
    // it gets the JWT from the sessionStorage and uses the 'genAddressSeed' function
    // to generate the address seed.
    ...
    // gets the Ed25519 keypair. It gets the JWT from the sessionStorage and uses the getExtendedEphemeralPublicKey 
    // function to generate the extended ephemeral public key. 
    // It then uses the extended ephemeral public key to generate the keypair.
